...
<nav class="navbar navbar-expand-lg navbar-light ">
        ...
        <div class="collapse navbar-collapse" id="navbarText">
          ...
          <li class="nav-item ">
            ...
            <li class="nav-item ">
              <a class="nav-link ml-2" href="buy.php">BUY</a>
            </li>
            <li class="nav-item">
        ...
        <li class="nav-item dropdown">
            ...
            <li class="nav-item ml-2">
              <a class="nav-link" href="basket.php"><i class="fa fa-shopping-bag" style="font-size:25px;"></i></a>
            </li>
        </ul>
        </div>
    </nav>
    <nav aria-label="breadcrumb" class="breadcrumb navbar-expand-lg bg-light" >
       <ol class="breadcrumb bg-light">
         ...
         <li class="breadcrumb-item"><a href="buy.php">Buy</a></li>
          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                   <img src="images/<?php $query = array('id' => $product_id); $cursor = $collection->find($query);   foreach ($cursor as $doc) { 
                     echo $doc["photo"];
